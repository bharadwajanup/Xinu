	...
	)
{
	...
	prptr->prdesc[prptr->prdesc_count++] = CONSOLE;	/* stdin  is CONSOLE device	*/
	prptr->prdesc[prptr->prdesc_count++] = CONSOLE;	/* stdout is CONSOLE device	*/
	prptr->prdesc[prptr->prdesc_count++] = CONSOLE;	/* stderr is CONSOLE device	*/
